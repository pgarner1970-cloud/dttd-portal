...
<head>
  ...
  <link rel="stylesheet" href="/assets/public-site.css?v=141">
</head>
...
<div class="option-one-crowd" aria-hidden="true"></div>
      ...
      <div class="option-one-inner">
        <div class="option-one-logo-shell"><img class="option-one-logo" src="/assets/dttd-logo-inner.png?v=141" alt="Dance Thru The Decades Events logo"></div>
