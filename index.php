...
<head>
  ...
  <link rel="stylesheet" href="/assets/public.css?v=128">
</head>
<body class="public-page option-one-page">
...
<main class="home-option-one">
  <section class="option-one-hero">
    ...
    <div class="option-one-inner">
      <img class="option-one-logo" src="/assets/dttd-logo.webp" alt="Dance Thru The Decades Events logo">

      <p class="option-one-eyebrow">60s · 70s · 80s · 90s · 00s</p>

      <h1>Dance Thru The<br>Decades Events</h1>
