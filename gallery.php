...
if ($is_access_attempt && !isset($_FILES['photo_upload'])) {
    [$access_event, $access_error] = dttd_handle_event_access_submission('/gallery.php');
    ...
    <section class="public-event-detail-section public-feature-section">
      <?php if (!$event): ?>
        <article class="public-empty-card public-access-card">
          ...
          <form class="public-access-form" method="post" action="/gallery.php">
      ...
      <?php else: ?>
        <article class="public-feature-card public-upload-card">
          ...
          <form class="public-request-form public-upload-form" method="post" action="/gallery.php" enctype="multipart/form-data">
