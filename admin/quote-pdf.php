...
$pdf->rect(365, 255, 190, 30, [1,1,1], $line);
$pdf->text(382, 266, 'SUBTOTAL', 10, true, $purple);
$pdf->text(485, 266, dttd_pdf_money($total), 10, true, $dark);
$pdf->rect(365, 225, 190, 30, $softGold, $line);
$pdf->text(382, 235, 'TOTAL', 13, true, $purple);
$pdf->text(485, 235, dttd_pdf_money($total), 13, true, $dark);
$pdf->rect(365, 195, 190, 30, $purple, $purple);
$pdf->text(382, 205, 'BALANCE DUE', 13, true, [1,1,1]);
$pdf->text(485, 205, dttd_pdf_money($total), 13, true, [1,1,1]);
