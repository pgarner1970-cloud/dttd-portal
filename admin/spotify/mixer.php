...
.track-search-badges{display:flex;gap:5px;flex-wrap:wrap;margin-top:5px}.track-search-badge{display:inline-flex;align-items:center;border-radius:999px;padding:2px 7px;font-size:10px;font-weight:1000;line-height:1.25;text-transform:uppercase;letter-spacing:.035em;border:1px solid rgba(148,163,184,.45);color:#dbeafe;background:rgba(148,163,184,.1)}.track-search-badge.decade{border-color:rgba(236,72,153,.65);background:rgba(236,72,153,.18);color:#ffd6f0}.track-search-badge.original{border-color:rgba(34,197,94,.72);background:rgba(34,197,94,.14);color:#8dffbb}.track-search-badge.remaster{border-color:rgba(59,130,246,.66);background:rgba(59,130,246,.13);color:#aad1ff}.track-search-badge.live,.track-search-badge.karaoke,.track-search-badge.cover{border-color:rgba(248,113,113,.68);background:rgba(248,113,113,.12);color:#ffc4c4}.track-search-badge.remix,.track-search-badge.acoustic,.track-search-badge.instrumental{border-color:rgba(168,85,247,.66);background:rgba(168,85,247,.13);color:#e6ccff}.track-search-badge.compilation{border-color:rgba(245,158,11,.65);background:rgba(245,158,11,.13);color:#ffd68a}
</style>
...
<script src="<?= h(admin_url('assets/spotify-mixer.js')) ?>?v=20260601-search-enrichment-v1"></script>
<?php admin_footer(); ?>
