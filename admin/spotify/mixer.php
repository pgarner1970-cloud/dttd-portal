...
/* Keep History tab visually aligned with Search Spotify and DJ Crates panels */
.source-panel[data-source-panel="history"] .source-list{background:transparent!important}
.source-panel[data-source-panel="history"] .history-row{background:rgba(255,255,255,.027)!important;border-color:rgba(96,145,205,.20)!important;box-shadow:none!important}
.source-panel[data-source-panel="history"] .history-row:hover{background:rgba(255,255,255,.04)!important;border-color:rgba(96,145,205,.26)!important}
</style>
...
<script src="<?= h(admin_url('assets/spotify-mixer.js')) ?>?v=20260601-history-panel-align"></script>
<?php admin_footer(); ?>
