  ...
  <div class="mixer-grid">
    <section class="mixer-panel mixer-panel-a">
      <div class="panel-head">
        <div class="deck-heading"><div class="deck-letter">A</div><div><h2>Player A</h2><div class="deck-device" id="deckADevice">Not assigned</div><div class="deck-account" id="deckAAccount">Spotify account: checking…</div></div></div>
    ...
    <section class="mixer-panel mixer-panel-b">
      <div class="panel-head">
        <div class="deck-heading"><div class="deck-letter">B</div><div><h2>Player B</h2><div class="deck-device" id="deckBDevice">Not assigned</div><div class="deck-account" id="deckBAccount">Spotify account: checking…</div></div></div>
