...
.library-selected-track-multi .library-selected-copy strong{
  color:#dbeafe;
}
.library-selected{
...
<main class="spotify-mixer-app" data-api="<?= h(admin_url('spotify/mixer-api.php')) ?>" data-search-api="/api/spotify-search.php" data-local-search-api="<?= h(admin_url('api/local-music-search.php')) ?>">
  ...
  <div class="mixer-top-note">
    ...
    <button class="mixer-btn blue mixer-top-library" type="button" id="openMusicLibrary">♫ Open Music Library</button>
    <a class="mixer-btn blue mixer-top-tools" href="<?= h(admin_url('spotify/index.php')) ?>">Spotify Tools</a>
  </div>
    ...
    <section class="mixer-panel mixer-centre">
      <div class="panel-body">
        <section class="dj-section">
          ...
          <div class="playlist-pager" id="playlistPager" hidden></div>
        </section>
