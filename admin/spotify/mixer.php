...
.deck-actions{display:block;margin-top:12px}.transport-controls{display:grid;grid-template-columns:1fr 1fr 1.22fr 1fr 1fr;gap:6px;align-items:stretch;margin-top:12px}.transport-btn{min-height:64px;border-radius:13px;flex-direction:column;gap:4px;font-size:16px;line-height:1.05;padding-left:8px;padding-right:8px}.transport-btn small{display:block;font-size:9px;letter-spacing:.03em;text-transform:uppercase;color:#c8d7e8}.transport-play{width:86px;height:86px;min-height:86px;border-radius:999px;justify-self:center;font-size:29px;letter-spacing:-5px;padding-right:10px}.transport-play.transport-ready{border-color:#ffb11a;color:#fff;background:radial-gradient(circle,rgba(255,177,26,.28),rgba(255,177,26,.08));box-shadow:0 0 0 0 rgba(255,177,26,.26),0 0 26px rgba(255,177,26,.25);animation:transportReady 1.05s ease-in-out infinite}.transport-play.transport-playing{border-color:#16c874;color:#fff;background:radial-gradient(circle,rgba(22,200,116,.28),rgba(22,200,116,.08));box-shadow:0 0 0 3px rgba(22,200,116,.14),0 0 28px rgba(22,200,116,.38)}.transport-under{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.transport-eject{min-height:48px}.transport-swap{min-height:48px;border-color:#ff9e16;color:#ffc455;background:rgba(255,158,22,.11)}@keyframes transportReady{0%,100%{box-shadow:0 0 0 0 rgba(255,177,26,.2),0 0 16px rgba(255,177,26,.3);filter:brightness(.95)}50%{box-shadow:0 0 0 5px rgba(255,177,26,.22),0 0 34px rgba(255,177,26,.72);filter:brightness(1.2)}}@media(max-width:700px){.transport-controls{grid-template-columns:repeat(5,minmax(54px,1fr));gap:6px}.transport-btn{min-height:62px;font-size:15px}.transport-play{width:78px;height:78px;min-height:78px;font-size:27px}.transport-under{grid-template-columns:1fr}.transport-btn small{font-size:9px}}
...
<script src="<?= h(admin_url('assets/spotify-mixer.js')) ?>?v=20260523-compact-decks-trial-v1"></script>
<?php admin_footer(); ?>
