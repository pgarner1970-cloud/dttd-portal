...
/* Keep mixer side decks independent from the centre column height and compress DJ playlist request rows. */
.mixer-panel-a,.mixer-panel-b{align-self:start}
.playlist-row{align-items:center}
.playlist-row .workflow-row,.playlist-request-summary{display:none!important}
.playlist-request-note-list.compact{margin-top:5px;gap:4px}
