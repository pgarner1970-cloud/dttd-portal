...
$logo_background = (string)($sponsor['logo_background'] ?? 'dark');
...
.sponsor-logo-preview.is-neon_pink {
  background:
...
.sponsor-logo-preview.is-starburst {
  background:
...
.sponsor-logo-preview.is-radial_neon {
  background:
