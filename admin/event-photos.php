...
?>
<style>
.photo-mod-wrap{max-width:1220px;margin:28px auto 56px;padding:0 20px;color:#fff}.photo-mod-panel{background:linear-gradient(135deg,rgba(15,34,58,.96),rgba(3,18,28,.96));border:1px solid rgba(83,145,222,.35);border-radius:24px;padding:26px;box-shadow:0 24px 70px rgba(0,0,0,.28)}.photo-mod-head{display:flex;justify-content:space-between;gap:20px;flex-wrap:wrap;align-items:flex-end}.photo-mod-head h1{font-size:34px;margin:0 0 8px}.photo-mod-head p{margin:0;color:#d8e7ff}.photo-filter-form{display:grid;grid-template-columns:minmax(180px,260px) minmax(260px,520px) auto;gap:14px;align-items:end}.photo-filter-form label{display:grid;gap:7px;font-weight:800}.photo-mod-wrap select,.photo-mod-wrap input[type=text],.photo-mod-wrap input[type=file]{min-height:46px;border:1px solid rgba(126,156,196,.45);border-radius:14px;background:#111a2a;color:#fff;padding:0 14px;font-weight:700;box-sizing:border-box}.photo-mod-wrap select{-webkit-appearance:none;-moz-appearance:none;appearance:none;padding-right:42px;background-color:#111a2a;background-image:linear-gradient(45deg,transparent 50%,#ffe85a 50%),linear-gradient(135deg,#ffe85a 50%,transparent 50%),linear-gradient(135deg,rgba(255,255,255,.06),rgba(255,255,255,0));background-position:calc(100% - 24px) 50%,calc(100% - 16px) 50%,0 0;background-size:8px 8px,8px 8px,100% 100%;background-repeat:no-repeat}.photo-mod-wrap select:hover,.photo-mod-wrap select:focus,.photo-mod-wrap input[type=text]:hover,.photo-mod-wrap input[type=text]:focus,.photo-mod-wrap input[type=file]:hover,.photo-mod-wrap input[type=file]:focus{border-color:rgba(255,232,90,.85);box-shadow:0 0 0 3px rgba(255,232,90,.12),0 0 18px rgba(44,119,232,.22);outline:none}.photo-mod-wrap option{background:#111a2a;color:#fff;font-weight:700}.photo-mod-wrap input[type=file]{display:flex;align-items:center;padding:9px 12px;color:#dbe8ff}.photo-mod-wrap input[type=file]::file-selector-button{margin-right:12px;border:1px solid #2c77e8;border-radius:11px;background:#072a58;color:#fff;font-weight:900;padding:8px 12px;cursor:pointer}.photo-mod-wrap input[type=file]::-webkit-file-upload-button{margin-right:12px;border:1px solid #2c77e8;border-radius:11px;background:#072a58;color:#fff;font-weight:900;padding:8px 12px;cursor:pointer}.photo-btn{border:1px solid rgba(126,156,196,.35);border-radius:14px;background:#202936;color:#fff;font-weight:900;padding:13px 17px;text-decoration:none;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;min-height:46px}.photo-btn-green{background:#073b25;border-color:#07c66b}.photo-btn-red{background:#350d16;border-color:#ff4b63}.photo-btn-blue{background:#072a58;border-color:#2c77e8}.photo-btn-danger{background:#48101a;border-color:#ff5c70}.photo-tabs{display:flex;gap:12px;flex-wrap:wrap;margin:22px 0 0}.photo-tab{display:inline-flex;gap:10px;align-items:center;border:1px solid #2b79e8;border-radius:999px;padding:11px 18px;color:#fff;text-decoration:none;font-weight:900;background:#08264b}.photo-tab.active{border-color:#f7cf26;background:#3b3003}.photo-count{background:#1c63c7;border-radius:999px;min-width:25px;height:25px;display:inline-flex;align-items:center;justify-content:center}.photo-admin-upload{display:grid;grid-template-columns:minmax(260px,2fr) minmax(180px,1fr) minmax(240px,1fr) minmax(92px,auto);gap:14px;align-items:end}.photo-admin-upload label{display:grid;gap:7px;font-weight:800;min-width:0}.photo-admin-upload .photo-btn{width:100%;white-space:normal}.photo-admin-upload input[type=file]{width:100%;min-width:0}.photo-admin-upload-card{margin-top:22px}.photo-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,250px));gap:22px;margin-top:26px}.photo-card{overflow:hidden;border:1px solid rgba(64,125,209,.46);border-radius:18px;background:#07101f;box-shadow:0 16px 38px rgba(0,0,0,.27)}.photo-thumb-link{display:block;background:#010612;border-bottom:1px solid rgba(255,255,255,.08)}.photo-thumb{display:block;width:100%;height:190px;object-fit:contain;background:#020817;padding:8px;box-sizing:border-box}.photo-card-body{padding:14px}.photo-card-meta{display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:12px}.photo-status{border:1px solid currentColor;border-radius:999px;padding:6px 11px;font-size:12px;font-weight:1000;text-transform:uppercase}.photo-status.pending{color:#ffdd2d}.photo-status.approved{color:#13d875}.photo-status.rejected{color:#ff6473}.photo-time{color:#a7bddb;font-weight:800;font-size:13px}.photo-title{font-size:18px;font-weight:1000;margin:0 0 6px}.photo-file,.photo-event{font-size:13px;color:#dbe8ff;margin:0 0 9px;word-break:break-word}.photo-note-label{display:grid;gap:7px;font-size:13px;font-weight:900;margin:10px 0}.photo-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}.photo-actions form{display:inline}.photo-actions .photo-btn{padding:10px 12px;min-height:42px;font-size:13px}.photo-notice{margin-top:20px;border-radius:14px;padding:13px 15px;background:#10233b;border:1px solid rgba(126,156,196,.35)}.photo-notice.success{border-color:#12b86a}.photo-notice.error{border-color:#ff5c70}@media(max-width:1180px){.photo-admin-upload{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}.photo-admin-upload .photo-btn{grid-column:1/-1}}@media(max-width:960px){.photo-admin-upload{grid-template-columns:1fr 1fr}}@media(max-width:820px){.photo-filter-form,.photo-admin-upload{grid-template-columns:1fr}.photo-grid{grid-template-columns:minmax(0,1fr)}.photo-card{max-width:360px}}
</style>
<div class="photo-mod-wrap">
  <section class="photo-mod-panel">
    ...
    <div class="photo-notice photo-admin-upload-card">
      <form class="photo-admin-upload" method="post" enctype="multipart/form-data">
        <label><span>Upload to event</span><select name="admin_event_id" required>
          <option value="">Choose event</option>
          <?php foreach ($eventOptions as $event): ?>
            <option value="<?= (int)$event['id'] ?>"><?= h(photo_event_label($event)) ?></option>
          <?php endforeach; ?>
        </select></label>
        <label><span>Photographer / name</span><input type="text" name="admin_guest_name" placeholder="Optional"></label>
        <label><span>Images</span><input type="file" name="admin_photos[]" accept="image/*" multiple required></label>
