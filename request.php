...
<head>
  ...
  <link rel="stylesheet" href="/assets/public-site.css?v=171">
</head>
        ...
        <article class="public-feature-card public-request-card">
          ...
          <form class="public-request-form" method="post" action="/request.php" data-spotify-request-form>
            ...
            <div class="public-request-grid">
              <div class="public-field public-field-name">
                <label for="guest_name">Your name *</label>
                <input id="guest_name" name="guest_name" required maxlength="120" placeholder="Your name">
              </div>

              <div class="public-field public-field-song">
                <label for="song_title">Song title *</label>
                <input id="song_title" name="song_title" required maxlength="190" placeholder="Example: September" autocomplete="off">
              </div>

              <div class="public-field public-field-artist">
                <label for="artist">Artist *</label>
                <input id="artist" name="artist" required maxlength="190" placeholder="Example: Earth, Wind & Fire" autocomplete="off">
              </div>
              ...
              <div class="spotify-search-box public-spotify-search-box">
                <div class="spotify-helper">Start typing a song or artist. Pick a Spotify match if one appears, or carry on with manual entry.</div>
              ...
              <div class="public-field public-field-message">
                <label for="dedication">Dedication / message</label>
                <textarea id="dedication" name="dedication" rows="4" placeholder="Optional message or dedication"></textarea>
              </div>
            </div>

            <div class="public-request-submit-row">
